...
use NIP24\Model\ModelInterface;
...
class ObjectSerializer
{
    ...
    /** @var string */
    private static $booleanFormatForQueryString = self::BOOLEAN_FORMAT_INT;
     ...
     */
    public static function setBooleanFormatForQueryString($booleanFormat)
    {
        self::$booleanFormatForQueryString = $booleanFormat;
    }
    ...
    {
        if (self::BOOLEAN_FORMAT_STRING == self::$booleanFormatForQueryString) {
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\NIP24\Model\\' . $data->{$discriminator};
    ...
    public static function buildQuery(array $params, $encoding = PHP_QUERY_RFC3986): string
    {
        ...
        $castBool = self::BOOLEAN_FORMAT_INT == self::$booleanFormatForQueryString
