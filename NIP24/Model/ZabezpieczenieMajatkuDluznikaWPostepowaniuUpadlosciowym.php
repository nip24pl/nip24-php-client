 ...
 */
class ZabezpieczenieMajatkuDluznikaWPostepowaniuUpadlosciowym implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ZabezpieczenieMajatkuDluznikaWPostepowaniuUpadlosciowym';
    ...
    protected static array $openAPINullables = [
        'organ_wydajacy' => false,
        'sygnatura_sprawy' => false,
        'data_nadania_klauzuli_wykonalnosci' => false,
        'informacja_o_przedmiocie_zabezpieczenia' => false,
        'rodzaj_postepowania' => false
    ];
    ...
    {
        $this->setIfExists('organ_wydajacy', $data ?? [], null);
        $this->setIfExists('sygnatura_sprawy', $data ?? [], null);
        $this->setIfExists('data_nadania_klauzuli_wykonalnosci', $data ?? [], null);
        $this->setIfExists('informacja_o_przedmiocie_zabezpieczenia', $data ?? [], null);
        $this->setIfExists('rodzaj_postepowania', $data ?? [], null);
    }
     ...
     * Sets organ_wydajacy
     *
     * @param string|null $organ_wydajacy organ_wydajacy
     *
     * @return self
     */
    public function setOrganWydajacy($organ_wydajacy)
    {
        if (is_null($organ_wydajacy)) {
            throw new \InvalidArgumentException('non-nullable organ_wydajacy cannot be null');
        }
     ...
     *
     * @param string|null $data_nadania_klauzuli_wykonalnosci data_nadania_klauzuli_wykonalnosci
     *
     * @return self
     */
    public function setDataNadaniaKlauzuliWykonalnosci($data_nadania_klauzuli_wykonalnosci)
    {
        if (is_null($data_nadania_klauzuli_wykonalnosci)) {
            throw new \InvalidArgumentException('non-nullable data_nadania_klauzuli_wykonalnosci cannot be null');
        }
     ...
     *
     * @param string|null $informacja_o_przedmiocie_zabezpieczenia informacja_o_przedmiocie_zabezpieczenia
     *
     * @return self
     */
    public function setInformacjaOPrzedmiocieZabezpieczenia($informacja_o_przedmiocie_zabezpieczenia)
    {
        if (is_null($informacja_o_przedmiocie_zabezpieczenia)) {
            throw new \InvalidArgumentException('non-nullable informacja_o_przedmiocie_zabezpieczenia cannot be null');
        }
     ...
     *
     * @param string|null $rodzaj_postepowania rodzaj_postepowania
     *
     * @return self
     */
    public function setRodzajPostepowania($rodzaj_postepowania)
    {
        if (is_null($rodzaj_postepowania)) {
            throw new \InvalidArgumentException('non-nullable rodzaj_postepowania cannot be null');
        }
